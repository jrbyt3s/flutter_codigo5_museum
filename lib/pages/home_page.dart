...
import 'package:flutter_codigo5_museum/models/museum_model.dart';
import 'package:flutter_codigo5_museum/services/api_service.dart';
import 'package:flutter_codigo5_museum/ui/general/general_widget.dart';
import 'package:flutter_swiper_null_safety/flutter_swiper_null_safety.dart';

import '../helpers/data/data_dummy.dart';
        ...
        children: [
                      ...
                      return Container(
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            fit: BoxFit.cover,
                            image: NetworkImage(
                              imagesDummy[index], //Lista urls de las imagenes
                            ),
                          ),
                        ),
                        child: Stack(
          ...
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                fit: BoxFit.cover,
                image: NetworkImage(
                  'https://image1.slideserve.com/1944008/slide38-l.jpg',
                ),
              ),
            ),
            child: Column(
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: museums
                  .map<Widget>(
                    (MuseumModel e) => ItemSlider2Widget(
                      museumModel: e,
                    ),
                  )
                  .toList(),
